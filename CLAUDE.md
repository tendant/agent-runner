...
- Agent workspace uses `workspace/` subdirectory as the agent's CWD; `state/` holds runner bookkeeping (TODO.md); shared repos cached in `repo-cache/` (REPO_CACHE_ROOT) between sessions
